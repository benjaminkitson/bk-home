...
var SYSTEM_CHROME_MAC = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome";
function getChromeExecutablePath() {
    if (process.platform === "darwin" && fs_1.default.existsSync(SYSTEM_CHROME_MAC)) {
...
var BASE_URL = (_a = process.env.BASE_URL) !== null && _a !== void 0 ? _a : "http://localhost:3000";
...
function captureThumbnails(startServer) {
    if (startServer === void 0) { startServer = false; }
    return __awaiter(this, void 0, void 0, function () {
        var stopServer, browser, executablePath, _i, ROUTES_1, _a, routePath, filename, url, outPath, page;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, puppeteer_1.default.launch(__assign({ headless: true }, (executablePath && { executablePath: executablePath })))];
                case 3:
                    browser = _b.sent();
                ...
                case 6:
                    _b.sent();
                    return [4 /*yield*/, page.goto(url, { waitUntil: "networkidle0", timeout: 15000 })];
                case 7:
                    _b.sent();
...
captureThumbnails(startServer).then(function () {
    console.log("Done.");
    process.exit(0);
}, function (err) {
    console.error(err);
